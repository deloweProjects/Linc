...
└── gemini-docs/        # Project documentation — single source of truth
```

## Documentation-first rule

- `gemini-docs/` is a first-class part of the project.
...
- Branch names: `feature/<short-name>`, `fix/<short-name>`, `gemini-docs/<short-name>`.
