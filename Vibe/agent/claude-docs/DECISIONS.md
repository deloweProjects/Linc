...
# Convergence phase (D-041…) — new milestone series (claude-docs/ROADMAP.md, 2026-07-22)

## D-041: Vendor scrcpy as an upstream-trackable submodule with an isolated window-chrome patch
**Date:** 2026-07-22 · **Status:** Accepted (planned, M2) · **Supersedes the "bundle at Polish" half of D-023**
